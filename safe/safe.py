...
def main():
    ...
    parser.add_argument('--iface',action="store",dest="iface",default='enp0s25')
    ...
    try:
        ...
        print 'Packet statistices: %d packets received,%d packets dropped,%d packets dropped by the interface'%pc.stats()
